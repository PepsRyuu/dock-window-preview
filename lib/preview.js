...
class ThumbComponent extends Component {
    ...
    onDraw(self, painter, bounds, theme) {
        ...
        painter.drawImage(w.img.data, { 
            x: PREVIEW_GAP, 
            y: PREVIEW_GAP + CAPTION_HEIGHT, 
            width: bounds.width - PREVIEW_GAP * 2, 
...
module.exports = {
    init () {
        ...
        function showPreview (pid, dockItem, windows) {
            ...
            let win_x = dockItem.x - (content_width + WINDOW_MARGIN * 2) / 2 + dockItem.width / 2;
            let win_y = dockItem.y - MARGIN_FROM_DOCK - (PREVIEW_HEIGHT + PREVIEW_GAP * 2) - WINDOW_MARGIN * 2;
